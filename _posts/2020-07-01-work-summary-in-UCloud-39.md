...
另一种方案，keys数组按照二叉搜索树的方式存储(二叉堆)，这样写入会是log(n),遍历的时候，对keys进行中序遍历log(n)，能得到排序的key
...
![epoll中的边缘触发ET和水平触发LT模式](https://www.dyxmq.cn/wp-content/uploads/2020/02/de279-image9733364675f8159c.png)
